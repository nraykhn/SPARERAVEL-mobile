...
import 'package:spareravel_mobile/widgets/product_card.dart';

class MyHomePage extends StatelessWidget {
    final String npm = '2306275701'; // NPM
    final String name = 'Nur Alya Khairina'; // Nama
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "SPARERAVEL" dengan teks putih dan tebal.
        title: const Text(
          'SPARERAVEL',
          style: TextStyle(
            color: Colors.white,
